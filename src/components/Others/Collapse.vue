<template>
    <div class="wk-collapse" >
        <div class="wk-collapse__title" ref="title" @click="toggleSlide">
            <!-- <img src="@/assets/icons/caret-down.svg" > -->
            <div class="wk-collapse__title-icon" :class="{'wk-collapsed': collapsed, 'wk-collapse__title-icon--arrow': arrow}">
                <fa-icon icon="chevron-down" />
            </div>
            
            <div class="wk-collapse__title-content" :class="{ 'wk-collapse__title-content--arrow': arrow}">
                <slot  name="title"/>
            </div>
            
        </div>
        <div class="wk-collapse__text" ref="text">
            <slot name="text"/>
        </div>
